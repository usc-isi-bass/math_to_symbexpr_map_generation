                ...
                class FuncSimProc(angr.SimProcedure):
                    def run(self):
                        ...
                        if len(arg_locs) == 0:
                            ...
                            func_cc.set_return_val(self.state, ret_bvs, ret_val_type)
                        else:
                            claripy_args = []
                            ...
                            func_cc.set_return_val(self.state, func_op(*claripy_args), ret_val_type)
                self.proj.hook_symbol(func_addr, FuncSimProc())
